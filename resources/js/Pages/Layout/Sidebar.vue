<template>
    <div class="w-3/5 rounded h-full overflow-hidden shadow-lg">
        ...
        <div class="px-6 py-4  font-semibold" v-if="editPage">
            ...
            <ul class="list-outside border pl-4 py-3 flex" :class="{'text-yellow-400' :  page.component === 'EditUser'}">
                <svg
        ...
        <Link :href="route('question.user')">
            <ul class="list-outside border pl-4 py-3 flex"  :class="{'text-yellow-400' :  page.component === 'UserQuestion'}">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
...
const editPage = computed(() => {
    return page.component === "EditUser" || page.component === "UserQuestion";
});
</script>
