<template>
    <div class="bg-primary text-white">
        ...
        >
            ...
            >
                <li class="text-sm font-bold hover:text-black md:mr-8">
                ...
                <li class="text-sm font-bold hover:text-black md:mr-8">
                    <Link href="/?type=answer">Answered Questions</Link>
                </li>
                <li class="text-sm font-bold hover:text-black md:mr-8">
                    
                    <Link href="/?type=unanswer">Unanswered Questions</Link>
                </li>
                <li
                    class="text-sm font-bold hover:text-black md:mr-8"
                ...
                >
                    ...
                    <img
                        :src="userImage"
                        alt=""
                        class="w-[50px] h-[50px] rounded-full outline hover:outline-2 hover:outline-cyan-600"
                    />
                    <div
                        v-if="showDropdown"
                        ref="target"
...
export default {
    setup() {
        ...
        const userImage = computed(
            () => `/${page.props.auth.user.url_storage}`
        );
