<template>
    <Master>
        <div class="mb-4" v-for="question in questions" :key="question.id">
        ...
        <!-- fixed -->
            <div class="flex items-center gap-x-1.5 ml-2">
                <span v-if="question.is_fixed == 'false' "
            ...
            <!-- fixed and delete -->
            <div class="flex items-center gap-x-1.5 mr-2" v-show="question.user_id == page.props.auth.user.id ">
                <span
        ...
        <div class="px-2 p-2 mt-3 border flex">
            ...
            <div class="ml-20">
                <span v-for="tag in question.tag" :key="tag.id"
...
const like = (id) => {
    router.post(route('like.store', { question_id: id }),{},{
        onSuccess:()=>{
